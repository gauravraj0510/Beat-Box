const keyData = {
	1: {
        sound: new Howl({
            urls: ["public/sounds/tom.wav"]
        }),
        color: "#db1d2d"
    },
    2: {
        sound: new Howl({
            urls: ["public/sounds/clap.wav"]
        }),
        color: "#f0421c"
    },
    3: {
        sound: new Howl({
            urls: ["public/sounds/kick.wav"]
        }),
        color: "#fec02d"
    },
    4: {
        sound: new Howl({
            urls: ["public/sounds/openhat.wav"]
        }),
        color: "#20d071"
    },
    5: {
        sound: new Howl({
            urls: ["public/sounds/boom.wav"]
        }),
        color: "#1a9ddb"
    },
    6: {
        sound: new Howl({
            urls: ["public/sounds/ride.wav"]
        }),
        color: "#a13fad"
    },
    7: {
        sound: new Howl({
            urls: ["public/sounds/snare.wav"]
        }),
        color: "#f26fd4"
    },
    8: {
        sound: new Howl({
            urls: ["public/sounds/wipe.mp3"]
        }),
        color: "#404be6"
    },
    9: {
        sound: new Howl({
            urls: ["public/sounds/splits.mp3"]
        }),
        color: "#00ff04"
    }
};
